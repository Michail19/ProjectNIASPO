...
Архитектура проекта содержит чёткое структурированное распределение подкаталогов по их назначению и обеспечивает стабильную работу различных сред разработки и тестирования.
