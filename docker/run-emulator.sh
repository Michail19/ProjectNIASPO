...
# Запуск openbox для оконного управления
openbox &
...
$ANDROID_HOME/emulator/emulator -avd test_avd -port 5554 -no-window -no-audio -gpu host -accel on -qemu -m 2048 &> /root/emulator.log &
